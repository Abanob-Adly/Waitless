...
const AR: Record<string, string> = {
  ...
  // ── Session (visit) notes ────────────────────────────────────────────────────
  "Session Notes": "ملاحظات الزيارة",
  "Failed to load existing notes.": "فشل تحميل الملاحظات الحالية.",
  "Failed to save notes. Please try again.": "فشل حفظ الملاحظات. حاول مرة أخرى.",
  "Chief Complaint": "الشكوى الرئيسية",
  "Diagnosis": "التشخيص",
  "Prescription": "الوصفة الطبية",
  "Follow-up": "متابعة",
  "General Notes": "ملاحظات عامة",
  "Share with Patient": "مشاركة مع المريض",
  "When shared, the patient can see these notes. Hidden by default.": "عند المشاركة، يمكن للمريض رؤية هذه الملاحظات. مخفية افتراضياً.",
  "Saved ✓": "تم الحفظ ✓",
  "View or edit session notes": "عرض أو تعديل ملاحظات الزيارة",
  "Patients & Notes": "المرضى والملاحظات",
  "Session Patients": "مرضى الجلسة",
  "Open a patient's notes from here": "افتح ملاحظات المريض من هنا",
  "No patients in this session.": "لا يوجد مرضى في هذه الجلسة.",
  "Doctor's Notes": "ملاحظات الطبيب",
  "No shared notes yet": "لا توجد ملاحظات مشتركة بعد",
  "When a doctor shares visit notes with you, they'll appear here.": "عندما يشارك الطبيب ملاحظات الزيارة معك، ستظهر هنا.",
  "Failed to load notes.": "فشل تحميل الملاحظات.",
  "Clinic ✓": "العيادة ✓",
  "Clinic — unpaid": "العيادة — غير مدفوع",
  "Paid at clinic": "مدفوع في العيادة",
  "Pay at clinic — not yet paid": "الدفع في العيادة — لم يُدفع بعد",
  "Mark clinic cash payment as received": "تحديد دفعة العيادة النقدية كمستلمة",
  "Notes": "ملاحظات",
  "Global Delay (min):": "تأخير عام (دقيقة):",
  "Update": "تحديث",
  "Delay updated ✓": "تم تحديث التأخير ✓",
  "Menu": "القائمة",
  "Suggested: enough time for": "مقترح: وقت كافٍ لـ",
  "min avg": "متوسط الدقائق",
  "suggested": "مقترح",
  ...
  "Come now — you're almost up!": "تعال الآن — دورك قريب!",
  ...
  "Off Day": "يوم إجازة",
  // Onboarding checklist (Overview tab)
  "Getting Started": "ابدأ الآن",
  "Complete these steps to start accepting patients on Waitless.": "أكمل هذه الخطوات لتبدأ في استقبال المرضى على Waitless.",
  "Create your first branch": "أنشئ أول فرع لك",
  "Add your clinic's location — doctors and schedules are attached to a branch.": "أضف موقع عيادتك — الأطباء والجداول مرتبطة بالفرع.",
  "Add Branch →": "إضافة فرع →",
  "Set up a doctor's schedule": "أنشئ جدول طبيب",
  "Define working hours and consultation fees so patients can book sessions.": "حدد ساعات العمل ورسوم الاستشارة حتى يتمكن المرضى من حجز الجلسات.",
  "Add Schedule →": "إضافة جدول →",
  "Add a branch first": "أضف فرعًا أولاً",
  "Upgrade your subscription": "قم بترقية اشتراكك",
  "Unlock marketplace listing, more branches, and higher patient limits — anytime you're ready.": "افتح الظهور في السوق، وفروعًا إضافية، وحدودًا أعلى للمرضى — في أي وقت تكون مستعدًا.",
