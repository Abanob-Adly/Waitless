...
// --- Mock API (replace with real axios call when backend is ready) ---
// Simulates: GET /api/appointments/:id/queue-status
...
export function LiveTicketPage() {
...
function StatBox({ label, value, accent = false }: StatBoxProps) {
  return (
    <div
